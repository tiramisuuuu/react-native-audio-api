...
export default class AudioBufferSourceNode extends AudioScheduledSourceNode {
  ...
  constructor(context, node, pitchCorrection) {
    ...
    if (pitchCorrection) {
      this.detune = new AudioParam(new IStretcherNodeAudioParam(0, this.setDetune.bind(this), 'a-rate', -1200, 1200, 0), context);
      this.playbackRate = new AudioParam(new IStretcherNodeAudioParam(1, this.setPlaybackRate.bind(this), 'a-rate', 0, Infinity, 1), context);
    } else {
